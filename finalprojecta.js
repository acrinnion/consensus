...
food = ["Holy Schnitzel", "Bagels", "Pizza", "Buffalo Wild Wings", "Red Lobster", "Golden Corral", "Cheesecake Factory", "Friendly’s", "Denny’s", "IHOP", "Maggiano’s Little Italy", "Joe’s Crab Shack", "Olive Garden", "Ruby Tuesdays", "TGI Friday’s", "Waffle House", "Holy Schnitzel","Peaches","McDonald","Taco Bell","Wendy’s ","Chick-fil-a","In-N-Out burger","Burger King","Subway","Dunkin’ Donut","Pizza Hut","Panera Bread","Chipotle ","Sonic Drive-In","KFC","Popeyes","Arby’s","Carl’s Jr.","Jack in the Box","Panda Express","Jimmy John’s","Whataburger","Bare Burger","Shake Shack","Five Guys","Zaxby’s","Culver’s","Bojangles’","Steak ‘n Shake","Papa Murphy’s","Church’s Chicken","Wingstop","Checkers","Qdoba","El Pollo Loco","Krispy Kreme","Del Taco","White Castle","Jersey Mike’s","Firehouse Subs","Jason’s Deli","Moe’s Southwest Grill","Tim Hortons","Boston Market","Baskin Robbins","McAlister’s Deli" ,"Captain D’s", "Auntie Anne’s", "Jamba Juice", "Tropical smoothie", "Chinese","Italian","Sushi","Indian food", "Southern food","Seafood","Spanish food"
];
...
function openfoodparampage(){
  ...
  document.getElementById("homepage").innerHTML = "<h2> You should get </h2>" + choice + " <p class='back' onclick = 'window.location.reload();'> Back to home </p>";
